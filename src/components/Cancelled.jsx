            ...
            <div className="flex justify-between items-center w-[100%]">
                <div className="flex flex-col justify-between h-[18vw]">
                    <div className="flex flex-col">
                        <p className="text-red-500 text-[4vw] font-extrabold">Cancelled<span className="text-[2.5vw] text-[#848484] font-normal mx-2">(July 7, 2023, 13:43 pm)</span></p>
                ...
                <img className="w-[7vw]" src={frame412} alt="" />
            </div>               
        </div>
    </>
  )
