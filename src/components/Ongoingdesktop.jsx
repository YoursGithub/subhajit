                  ...
                  <div className='rounded-xl w-[600px]  border-[1px] border-[#8F8F8F]'>
                    ...
                    <div className='flex items-center justify-between px-2 mt-2 mb-3'>
                        <div className='flex gap-2 items-center'>
                            ...
                            <p className='text-[13px] font-bold opacity-60'>shyamaprasad road house number 5</p>
                        </div>
                        <h2 className='text-[#094446] font-bold text-[22px] mt-[-2%]'>AS89K</h2>
                    </div>
                  </div>
                </div>
    </>
